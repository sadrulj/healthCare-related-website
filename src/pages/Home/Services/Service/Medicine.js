    ...
    <div className="wrapper antialiased text-gray-900 gap-x-3 p-5">
      <div>
        <img
          src={image}
          alt=" random imgee"
          className="w-full h-80 gap-x-4 object-cover object-center rounded-lg shadow-lg"
        />
        ...
        <div className="relative px-4 -mt-16  ">
          <div className="bg-white p-6 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
            <div className="flex items-baseline">
              <span className="bg-yellow-200 text-yellow-800 text-xs p-1 inline-block rounded-full  uppercase font-semibold tracking-wide">
                {productType}
              </span>
